...
public class ClientEffectHandlers {
	...
	public static void echoEffectActivation(Player player) {
		...
		Minecraft.getInstance().gameRenderer.displayItemActivation(EnchantedBookItem.createForEnchantment(new EnchantmentInstance(CEEnchantments.ECHO_EFFECT.holder(), 1)));
	}
