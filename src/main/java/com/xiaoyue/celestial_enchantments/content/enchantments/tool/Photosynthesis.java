...
public class Photosynthesis extends GeneralEnch implements ToolTickEnch {
	...
	private static int dur() {
		return CEModConfig.SERVER.ench.tool.photosynthesisInterval.get();
	}

	private static int light() {
		return CEModConfig.SERVER.ench.tool.photosynthesisMinLight.get();
	}

	private static int recover() {
		return CEModConfig.SERVER.ench.tool.photosynthesisRecover.get();
	}
	...
	@Override
	public void onLivingTick(EntityTickEvent.Post event, ItemStack stack, int level) {
