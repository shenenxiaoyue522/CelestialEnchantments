...
public class BornInShadow extends GeneralEnch implements ToolTickEnch {
	...
	private static int dur() {
		return CEModConfig.SERVER.ench.tool.bornInShadowInterval.get();
	}

	private static int light() {
		return CEModConfig.SERVER.ench.tool.bornInShadowMaxLight.get();
	}

	private static int recover() {
		return CEModConfig.SERVER.ench.tool.bornInShadowRecover.get();
	}
