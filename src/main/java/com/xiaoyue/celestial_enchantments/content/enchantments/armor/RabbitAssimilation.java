...
public class RabbitAssimilation extends ArmorEnch implements LivingTickEnch {

	private static final EnchEffectEntry EFF = EnchEffectEntry.amp(() -> MobEffects.JUMP, () -> 0);

	public RabbitAssimilation() {
		super(Rarity.RARE, Type.LEGS, EnchData.normal(4, EFFECT));
	}

	@Override
	public void onLivingTick(LivingEvent.LivingTickEvent event, LivingEntity entity, int level) {
		if (entity.isShiftKeyDown()) {
			selfEffect(entity, MobEffects.JUMP, level - 1);
		}
	}
