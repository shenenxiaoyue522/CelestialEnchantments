...
public class CorruptScholar extends ArmorEnch implements ChangeXpEnch {
	...
	private static double exp() {
		return CEModConfig.SERVER.ench.armor.corruptScholarExpBonus.get();
	}

	private static double chance() {
		return CEModConfig.SERVER.ench.armor.corruptScholarChance.get();
	}

	private static int dur() {
		return CEModConfig.SERVER.ench.armor.corruptScholarDuration.get();
	}
