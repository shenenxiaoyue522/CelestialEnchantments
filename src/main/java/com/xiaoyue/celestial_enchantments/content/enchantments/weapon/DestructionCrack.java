...
public class DestructionCrack extends AttackEnch {
	...
	private static int duration() {
		return CEModConfig.SERVER.ench.weapon.destructionCrackDuration.get();
	}
	...
	public void onDamageTargetFinal(LivingEntity user, LivingEntity target, DamageData.DefenceMax data, int lv) {
		target.addEffect(new MobEffectInstance(CEEffects.DESTRUCTED.val(), duration() * 20 * lv, 0, false, false, false), target);
	}
